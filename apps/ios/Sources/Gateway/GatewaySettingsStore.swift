...
enum GatewaySettingsStore {
    private static let gatewayService = "bot.ozzo.gateway"
    private static let legacyGatewayService = "com.ozzobot.gateway"
    private static let legacyBridgeService = "com.ozzobot.bridge"
    private static let nodeService = "bot.ozzo.node"
    private static let legacyNodeService = "com.ozzobot.node"
