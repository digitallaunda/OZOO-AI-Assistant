...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: OzzoLocationMode) async -> CLAuthorizationStatus {
    ...
    private static func accuracyValue(_ accuracy: OzzoLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
