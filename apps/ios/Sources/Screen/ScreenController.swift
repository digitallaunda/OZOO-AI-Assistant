...
final class ScreenController {
    ...
    /// Callback invoked when a ozzo:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = OzzoKitResources.bundle
...
/// Handles navigation policy to intercept ozzo:// deep links from canvas
@MainActor
