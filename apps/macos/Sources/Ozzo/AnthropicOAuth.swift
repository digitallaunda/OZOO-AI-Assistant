...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Ozzo token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: OzzoOAuthStore.AnthropicOAuthStatus = OzzoOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "bot.ozzo", category: "anthropic-oauth")
...
enum OzzoOAuthStore {
    ...
    private static let ozzoOAuthDirEnv = "OZZOBOT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Ozzo OAuth token file not found"
            case .unreadableFile: "Ozzo OAuth token file not readable"
            case .invalidJSON: "Ozzo OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Ozzo OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Ozzo OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.ozzoOAuthDirEnv]?
