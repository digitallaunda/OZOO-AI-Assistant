...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "bot.ozzo", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Ozzo/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__ozzo__/a2ui/").absoluteString + "?platform=macos"
    }
