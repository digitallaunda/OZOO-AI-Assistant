...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "bot.ozzo", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".ozzobot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.ozzoCommand(
            subcommand: "gateway",
