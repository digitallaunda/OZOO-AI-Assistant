...
enum UIStrings {
    static let welcomeTitle = "Welcome to Ozzo"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OzzoOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OzzoChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g ozzo@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OzzoChatViewModel(
