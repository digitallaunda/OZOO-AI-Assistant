...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .ozzoSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OzzoPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OzzoPaths.stateDirURL.path
...
extension Notification.Name {
    static let ozzoSelectSettingsTab = Notification.Name("ozzoSelectSettingsTab")
}
