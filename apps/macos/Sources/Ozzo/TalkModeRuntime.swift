...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "bot.ozzo", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "bot.ozzo", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OzzoChatMessage] = messages.compactMap { item in
