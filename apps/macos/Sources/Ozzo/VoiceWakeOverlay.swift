...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "bot.ozzo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Ozzo windows, but below the system’s pop-up menus.
