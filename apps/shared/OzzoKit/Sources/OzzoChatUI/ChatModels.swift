...
public typealias OzzoPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OzzoPlatformImage = UIImage
#endif

public struct OzzoChatUsageCost: Codable, Hashable, Sendable {
...
public struct OzzoChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OzzoChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OzzoChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OzzoChatMessageContent: Codable, Hashable, Sendable {
...
public struct OzzoChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OzzoChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OzzoChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OzzoChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OzzoChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OzzoChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OzzoChatMessageContent].self, forKey: .content) {
...
public struct OzzoChatHistoryPayload: Codable, Sendable {
...
public struct OzzoSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OzzoSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OzzoSessionPreviewItem]
}

public struct OzzoSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OzzoSessionPreviewEntry]

    public init(ts: Int, previews: [OzzoSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OzzoChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OzzoChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OzzoAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OzzoChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OzzoGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OzzoPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OzzoPlatformImage?
...
public struct OzzoChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
