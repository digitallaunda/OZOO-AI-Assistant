...
enum OzzoPlatformImageFactory {
    static func image(_ image: OzzoPlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
