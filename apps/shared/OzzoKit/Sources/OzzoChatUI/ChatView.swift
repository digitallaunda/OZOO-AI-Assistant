...
@MainActor
public struct OzzoChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OzzoChatViewModel
    ...
    private var visibleMessages: [OzzoChatMessage] {
        let base: [OzzoChatMessage]
    ...
    private func mergeToolResults(in messages: [OzzoChatMessage]) -> [OzzoChatMessage] {
    ...
    private func isToolResultMessage(_ message: OzzoChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OzzoChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OzzoChatMessage) -> String {
