...
public enum OzzoCanvasA2UICommand: String, Codable, Sendable {
...
public struct OzzoCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OzzoCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
