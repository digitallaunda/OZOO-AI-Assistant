...
- Install via CLI: `ozzo plugins install @ozzo/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `ozzo plugins install ./extensions/zalo`
   - From npm (if published): `ozzo plugins install @ozzo/zalo`
...
- Approve via:
  - `ozzo pairing list zalo`
  - `ozzo pairing approve zalo <CODE>`
...
- Example: `ozzo message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `ozzo channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `ozzo logs --follow`
