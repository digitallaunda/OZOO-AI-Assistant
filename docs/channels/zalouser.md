...
read_when:
  - Setting up Zalo Personal for Ozzo
...
- Install via CLI: `ozzo plugins install @ozzo/zalouser`
- Or from a source checkout: `ozzo plugins install ./extensions/zalouser`
...
Approve via:
- `ozzo pairing list zalouser`
- `ozzo pairing approve zalouser <code>`
...
- On startup, Ozzo resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `ozzo channels logout --channel zalouser && ozzo channels login --channel zalouser`
