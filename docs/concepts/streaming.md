...
Ozzo has two separate “streaming” layers:
...
When block streaming is enabled, Ozzo can **merge consecutive block chunks**
...
When draft streaming is active, Ozzo disables block streaming for that reply to avoid double-streaming.
