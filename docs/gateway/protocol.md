...
Ozzo. All clients (CLI, web UI, macOS app, iOS/Android nodes, headless
...
- If `OZOOBOT_GATEWAY_TOKEN` (or `--token`) is set, `connect.params.auth.token`
