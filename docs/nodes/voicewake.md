...
Ozzo treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.ozzobot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["ozzo", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
