...
- Same path: run the app from a fixed location (for Ozzo, `dist/Ozzo.app`).
...
```bash
sudo tccutil reset Accessibility bot.ozoo.mac
sudo tccutil reset ScreenCapture bot.ozoo.mac
