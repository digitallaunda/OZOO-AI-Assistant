...
You can point Ozzo at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Ozzo
...
- [Anthropic provider](/providers/anthropic) - Native Ozzo integration with Claude setup-token or API keys
