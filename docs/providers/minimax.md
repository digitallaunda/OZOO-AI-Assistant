---
summary: "Use MiniMax M2.1 in Ozzo"
read_when:
  - You want MiniMax models in Ozzo
...
Configure manually via `ozzo.json`:
...
- Use `ozzo models list` and `ozzo models set minimax/MiniMax-M2.1` to switch.
...
- Running `ozzo configure` and selecting **MiniMax M2.1**, or
