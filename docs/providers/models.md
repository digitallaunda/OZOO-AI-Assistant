---
summary: "Model providers (LLMs) supported by Ozzo"
read_when:
...
Ozzo can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `ozzo onboard`).
