---
summary: "Use Qwen OAuth (free tier) in Ozzo"
read_when:
  - You want to use Qwen with Ozzo
...
```bash
ozzo models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Ozzo will sync credentials
