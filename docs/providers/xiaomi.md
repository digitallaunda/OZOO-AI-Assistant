---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Ozzo"
read_when:
  - You want Xiaomi MiMo models in Ozzo
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Ozzo uses
...
```bash
ozzo onboard --auth-choice xiaomi-api-key
# or non-interactive
ozzo onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
