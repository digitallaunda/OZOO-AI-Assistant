...
import { removeAckReactionAfterReply, shouldAckReaction } from "ozzo/plugin-sdk";
import type { OzzoConfig, PluginRuntime } from "ozzo/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/ozzo") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
