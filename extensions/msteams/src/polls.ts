...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["ozzoPollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["ozzo", "pollId"]) ??
    readNestedString(value, ["ozzo", "poll", "id"]) ??
    readNestedString(value, ["data", "ozzoPollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "ozzo", "pollId"]);
