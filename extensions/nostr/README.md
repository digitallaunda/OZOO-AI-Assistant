...
Nostr DM channel plugin for Ozzo using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Ozzo. It enables your bot to:
...
# Configure ozzo to use local relay
