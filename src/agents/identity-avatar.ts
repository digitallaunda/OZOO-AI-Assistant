...
function resolveAvatarSource(cfg: OzzoConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OzzoConfig, agentId: string): AgentAvatarResolution {
