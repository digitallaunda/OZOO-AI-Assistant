...
describe("Agent-specific tool filtering", () => {
  it("should apply global tool policy when no agent-specific policy exists", () => {
    ...
    const tools = createOzzoCodingTools({
      config: cfg,
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createOzzoCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createOzzoCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createOzzoCodingTools({
      config: cfg,
    ...
    const defaultTools = createOzzoCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createOzzoCodingTools({
      config: cfg,
    ...
    const bobTools = createOzzoCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createOzzoCodingTools({
      config: cfg,
