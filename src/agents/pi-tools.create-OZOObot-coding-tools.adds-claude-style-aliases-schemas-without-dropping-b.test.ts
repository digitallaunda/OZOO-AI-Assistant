...
describe("createOzzoCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOzzoCodingTools({
      config,
    ...
    const anthropicTools = createOzzoCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOzzoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOzzoCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
