...
function resolveMainSessionKeyForSandbox(params: { cfg?: OzzoConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: OzzoConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`ozzo sandbox explain --session ${runtime.sessionKey}`)}`);
