...
import type { OzzoConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: OzzoConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: OzzoConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "ozzo-bundled";
}

export function resolveBundledAllowlist(config?: OzzoConfig): string[] | undefined {
