import type { OzzoConfig } from "../config/types.js";
...
export function isCommandEnabled(cfg: OzzoConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: OzzoConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: OzzoConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: OzzoConfig) {
