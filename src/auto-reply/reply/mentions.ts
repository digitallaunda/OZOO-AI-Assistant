...
function resolveMentionPatterns(cfg: OzzoConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: OzzoConfig | undefined, agentId?: string): RegExp[] {
