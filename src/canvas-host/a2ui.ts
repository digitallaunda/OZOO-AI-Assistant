...
export const A2UI_PATH = "/__ozzo__/a2ui";
export const CANVAS_HOST_PATH = "/__ozzo__/canvas";
export const CANVAS_WS_PATH = "/__ozzo/ws";
...
(() => {
  ...
  const handlerNames = ["ozzoCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Ozzo = globalThis.Ozzo ?? {};
  globalThis.Ozzo.postMessage = postToNode;
  globalThis.Ozzo.sendUserAction = sendUserAction;
  globalThis.ozzoPostMessage = postToNode;
  globalThis.ozzoSendUserAction = sendUserAction;
  globalThis.ozzoPostMessage = postToNode;
  globalThis.ozzoSendUserAction = sendUserAction;
