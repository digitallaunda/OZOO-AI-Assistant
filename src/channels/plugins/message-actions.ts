...
export function listChannelMessageActions(cfg: OzzoConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OzzoConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: OzzoConfig): boolean {
  for (const plugin of listChannelPlugins()) {
