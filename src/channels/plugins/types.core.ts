...
export type ChannelAgentToolFactory = (params: { cfg?: OzzoConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OzzoConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OzzoConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OzzoConfig }) => boolean;
  supportsCards?: (params: { cfg: OzzoConfig }) => boolean;
