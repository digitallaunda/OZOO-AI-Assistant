const DEFAULT_TAGLINE = "All your chats, one Ozzo.";
...
const TAGLINES: string[] = [
  ...
  "I'll streamline your workflow: messy, delicious, effective.",
  ...
  "The only contact you actually want to hear from. 🐙",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.OZZO_TAGLINE_INDEX;
