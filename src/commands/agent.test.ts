...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "ozzo-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OzzoConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OzzoConfig["telegram"]>>,
