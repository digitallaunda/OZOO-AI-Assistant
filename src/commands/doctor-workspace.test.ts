...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/ozzo when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/ozzo";
    const candidate = path.join(home, "ozzo");
  ...
  it("flags ~/ozzo when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/ozzo";
    const candidate = path.join(home, "ozzo");
