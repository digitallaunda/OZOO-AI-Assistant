...
export function applyZaiConfig(cfg: OzzoConfig): OzzoConfig {
...
export function applyOpenrouterProviderConfig(cfg: OzzoConfig): OzzoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OzzoConfig): OzzoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OzzoConfig): OzzoConfig {
...
export function applyOpenrouterConfig(cfg: OzzoConfig): OzzoConfig {
...
export function applyMoonshotProviderConfig(cfg: OzzoConfig): OzzoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: OzzoConfig): OzzoConfig {
...
export function applyKimiCodeProviderConfig(cfg: OzzoConfig): OzzoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OzzoConfig): OzzoConfig {
...
export function applySyntheticProviderConfig(cfg: OzzoConfig): OzzoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OzzoConfig): OzzoConfig {
...
export function applyXiaomiProviderConfig(cfg: OzzoConfig): OzzoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OzzoConfig): OzzoConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OzzoConfig): OzzoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OzzoConfig): OzzoConfig {
