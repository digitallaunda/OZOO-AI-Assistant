export const LEGACY_PROJECT_NAME = "ozzo" as const;
...
export const LEGACY_MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Ozzo" as const;

export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/Ozzo" as const;
