...
function resolveAnthropicDefaultAuthMode(cfg: OzzoConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OzzoConfig): OzzoConfig {
...
export function applyTalkApiKey(config: OzzoConfig): OzzoConfig {
...
export function applyModelDefaults(cfg: OzzoConfig): OzzoConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OzzoConfig): OzzoConfig {
...
export function applyLoggingDefaults(cfg: OzzoConfig): OzzoConfig {
...
export function applyContextPruningDefaults(cfg: OzzoConfig): OzzoConfig {
...
export function applyCompactionDefaults(cfg: OzzoConfig): OzzoConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
