...
export function parseOzzoVersion(raw: string | null | undefined): OzzoVersion | null {
  if (!raw) return null;
...
export function compareOzzoVersions(
  a: string | null | undefined,
  b: string | null | undefined,
): number | null {
  const parsedA = parseOzzoVersion(a);
  const parsedB = parseOzzoVersion(b);
