...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    OZZO_PROFILE: profile,
    OZZO_STATE_DIR: env.OZZO_STATE_DIR,
    OZZO_CONFIG_PATH: env.OZZO_CONFIG_PATH,
    OZZO_GATEWAY_PORT: String(port),
    OZZO_GATEWAY_TOKEN: token,
    OZZO_LAUNCHD_LABEL: resolvedLaunchdLabel,
    OZZO_SYSTEMD_UNIT: systemdUnit,
    OZZO_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    OZZO_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    OZZO_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    OZZO_STATE_DIR: env.OZZO_STATE_DIR,
    OZZO_CONFIG_PATH: env.OZZO_CONFIG_PATH,
    OZZO_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    OZZO_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    OZZO_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    OZZO_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    OZZO_LOG_PREFIX: "node",
    OZZO_SERVICE_MARKER: NODE_SERVICE_MARKER,
    OZZO_SERVICE_KIND: NODE_SERVICE_KIND,
    OZZO_SERVICE_VERSION: VERSION,
  };
}
