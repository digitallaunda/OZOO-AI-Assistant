...
import { type OzzoConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OzzoConfig): string[] {
...
export function listAgentsForGateway(cfg: OzzoConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OzzoConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: OzzoConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: OzzoConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OzzoConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OzzoConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OzzoConfig): GatewaySessionsDefaults {
