...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OzzoConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OzzoConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OzzoConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: OzzoConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: OzzoConfig): void {
