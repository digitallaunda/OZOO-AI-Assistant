...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "ozzo-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOzzoPackageRoot } = await import("./ozzo-root.js");
    ...
    vi.mocked(resolveOzzoPackageRoot).mockResolvedValue("/opt/ozzo");
