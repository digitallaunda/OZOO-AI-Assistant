...
export const DEFAULT_LOG_DIR = "/tmp/ozzo";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "ozzo.log"); // legacy single-file path

const LOG_PREFIX = "ozzo";
...
function resolveSettings(): ResolvedSettings {
  let cfg: OzzoConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => OzzoConfig;
      };
