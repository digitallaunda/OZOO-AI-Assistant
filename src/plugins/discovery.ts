...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @ozzo/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageOzzo: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverOzzoPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".ozzo", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
