...
export const PLUGIN_MANIFEST_FILENAME = "ozzo.plugin.json";
...
// package.json "ozzo" metadata (used for onboarding/catalog)
...
export type OzzoPackageManifest = {
  extensions?: string[];
...
): OzzoPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.ozzo ?? manifest[LEGACY_MANIFEST_KEY];
}
