...
export function listBindings(cfg: OzzoConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: OzzoConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OzzoConfig) {
