...
export function resolveTtsConfig(cfg: OzzoConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.OZZO_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: OzzoConfig): string | undefined {
